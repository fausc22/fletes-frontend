// pages/viajes/historial.jsx - HISTORIAL DE VIAJES COMPLETO
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {mostrarFiltros && (
          <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
            <h3 className="text-lg font-bold text-gray-800 mb-4">Filtrar Viajes</h3>
        ...
        {viajes.length === 0 ? (
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">No se encontraron viajes</h3>
            <p className="text-gray-600 mb-8">Intenta ajustar los filtros o crear un nuevo viaje</p>
            <Link 
              href="/viajes/nuevo" 
              className="bg-purple-600 text-white px-8 py-4 rounded-lg hover:bg-purple-700 transition-colors text-lg font-medium inline-flex items-center space-x-2"
            >
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
                    <div className="bg-gray-50 rounded-lg p-3">
                      ...
                      <p className="text-sm font-bold text-gray-800">{formatearFecha(viaje.fecha_inicio)}</p>
                    </div>
                    
                    <div className="bg-gray-50 rounded-lg p-3">
                      <h4 className="text-xs font-medium text-gray-600 mb-1">Fecha Fin</h4>
                      <p className="text-sm font-bold text-gray-800">{formatearFecha(viaje.fecha_fin)}</p>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-3">
                      ...
                      <p className="text-sm font-bold text-gray-800">#{viaje.id}</p>
                    </div>
                  </div>
                  ...
                  {viaje.observaciones && (
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                      ...
                      <p className="text-sm text-blue-700">{viaje.observaciones}</p>
                    </div>
                  )}
        ...
        {viajes.length > 0 && (
          <div className="bg-white rounded-xl shadow-lg p-6 mt-6">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Resumen del Historial</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-blue-50 rounded-lg p-4 text-center">
                ...
                <div className="text-sm text-blue-700">En Curso</div>
              </div>
              ...
              <div className="bg-purple-50 rounded-lg p-4 text-center">
                ...
                <div className="text-sm text-purple-700">Km Totales</div>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link href="/viajes/activos" className="bg-blue-50 border border-blue-200 rounded-lg p-4 hover:bg-blue-100 transition-colors">
              <div className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z"/>
                </svg>
                <span className="font-medium text-blue-800">Viajes Activos</span>
              </div>
            </Link>

            <Link href="/reportes/viajes" className="bg-purple-50 border border-purple-200 rounded-lg p-4 hover:bg-purple-100 transition-colors">
              <div className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
                <span className="font-medium text-purple-800">Generar Reporte</span>
              </div>
            </Link>

            <Link href="/dinero" className="bg-orange-50 border border-orange-200 rounded-lg p-4 hover:bg-orange-100 transition-colors">
              <div className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"/>
                </svg>
                <span className="font-medium text-orange-800">Ver Finanzas</span>
              </div>
            </Link>
          </div>
        </div>
