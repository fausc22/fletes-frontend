  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 p-4 sm:p-6">
      ...
      <Link href="/dinero/nuevo-ingreso">
        <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 hover:scale-105 border-l-8 border-green-500 min-h-[250px] flex flex-col justify-center items-center text-center cursor-pointer group">
          ...
          <h2 className="text-4xl font-bold text-gray-800 mb-3">NUEVO INGRESO</h2>
          <p className="text-gray-600 text-lg">Registrar cobros y entradas de dinero</p>
        </div>
      </Link>

      {/* NUEVO GASTO */}
      <Link href="/dinero/nuevo-gasto">
        <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 hover:scale-105 border-l-8 border-red-500 min-h-[250px] flex flex-col justify-center items-center text-center cursor-pointer group">
          <div className="bg-gradient-to-r from-red-100 to-red-200 p-6 rounded-full mb-6 group-hover:scale-110 transition-transform">
            <svg className="w-20 h-20 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4"/>
            </svg>
          </div>
          <h2 className="text-4xl font-bold text-gray-800 mb-3">NUEVO GASTO</h2>
          <p className="text-gray-600 text-lg">Registrar pagos y salidas de dinero</p>
        </div>
      </Link>

      {/* BALANCE */}
      <Link href="/dinero/balance">
        <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 hover:scale-105 border-l-8 border-blue-500 min-h-[250px] flex flex-col justify-center items-center text-center cursor-pointer group">
          ...
          <h2 className="text-4xl font-bold text-gray-800 mb-3">BALANCE</h2>
          <p className="text-gray-600 text-lg">Ver reportes e historial completo</p>
        </div>
      </Link>
    </div>
