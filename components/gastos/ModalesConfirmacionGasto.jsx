  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        <h3 className="text-xl font-bold mb-4 text-center">Confirmar Registro de Gasto</h3>
        <div className="text-center mb-6">
          <p className="mb-2">
            ¿Desea confirmar el registro del gasto por{' '}
            <span className="font-bold text-blue-700">{descripcion}</span> de{' '}
            <span className="font-bold text-green-700">${monto}</span> pagado en{' '}
...
export function ModalConfirmacionSalidaGasto({ mostrar, onConfirmar, onCancelar }) {
  if (!mostrar) return null;
