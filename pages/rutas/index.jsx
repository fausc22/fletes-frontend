// pages/rutas/index.jsx - PÁGINA PRINCIPAL DE RUTAS - RESPONSIVE MEJORADA
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-indigo-50 to-indigo-100 p-4">
        <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg">
          ...
          <span className="text-indigo-800 text-sm sm:text-base">Cargando rutas...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-indigo-100 p-4 sm:p-6">
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">GESTIÓN DE RUTAS</h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
              <button
                onClick={refresh}
                className="bg-white bg-opacity-20 hover:bg-opacity-30 px-4 py-2 rounded-lg transition-all flex items-center justify-center space-x-2 text-sm sm:text-base"
                disabled={loading}
              >
              ...
              <button
                ...
                className="bg-white bg-opacity-20 hover:bg-opacity-30 px-4 sm:px-6 py-2 rounded-lg transition-all flex items-center justify-center space-x-2 text-sm sm:text-base"
              >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-indigo-500">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-800">{estadisticas.total_rutas}</h3>
                  <p className="text-xs sm:text-sm text-gray-600">Total de rutas</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-green-500">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-800">{estadisticas.rutas_activas}</h3>
                  <p className="text-xs sm:text-sm text-gray-600">Rutas activas</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-blue-500">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-800">{estadisticas.rutas_con_viajes}</h3>
                  <p className="text-xs sm:text-sm text-gray-600">Con viajes</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-yellow-500">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">Distancia promedio</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {rutasRentables && rutasRentables.length > 0 && (
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-2 sm:space-y-0">
              ...
              <Link 
                href="/reportes/rutas" 
                className="text-indigo-600 hover:text-indigo-800 text-sm font-medium inline-flex items-center space-x-1"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {rutasRentables.slice(0, 3).map((ruta, index) => (
                <div key={ruta.id} className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
                  ...
                  <h3 className="font-bold text-gray-800 mb-1 truncate">{ruta.nombre}</h3>
                  <p className="text-sm text-gray-600 mb-2 truncate">{ruta.origen} → {ruta.destino}</p>
        ...
        {/* Lista de rutas - RESPONSIVE CONTAINER */}
          ...
          <div className="p-4 sm:p-6 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                <Link 
                  href="/viajes/nuevo" 
                  className="text-green-600 hover:text-green-800 text-sm font-medium flex items-center justify-center space-x-1 bg-green-50 hover:bg-green-100 px-3 py-2 rounded-lg transition-colors"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                  </svg>
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-xl p-4 sm:p-6 mt-6 sm:mt-8">
          <div className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-1 text-indigo-100 text-sm sm:text-base">
        ...
        {/* Accesos rápidos - RESPONSIVE GRID */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mt-6">
          <Link href="/viajes/nuevo" className="bg-white rounded-lg p-3 sm:p-4 shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
              <div className="bg-green-100 p-2 rounded-lg self-start sm:self-center">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                </svg>
              </div>
              <span className="font-medium text-gray-800 text-sm sm:text-base">Iniciar Viaje</span>
            </div>
          </Link>

          <Link href="/viajes/activos" className="bg-white rounded-lg p-3 sm:p-4 shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
              ...
              <span className="font-medium text-gray-800 text-sm sm:text-base">Viajes Activos</span>
            </div>
          </Link>

          <Link href="/reportes/rutas" className="bg-white rounded-lg p-3 sm:p-4 shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
              <div className="bg-purple-100 p-2 rounded-lg self-start sm:self-center">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
              </div>
              <span className="font-medium text-gray-800 text-sm sm:text-base">Ver Reportes</span>
            </div>
          </Link>

          <Link href="/camiones" className="bg-white rounded-lg p-3 sm:p-4 shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
              <div className="bg-orange-100 p-2 rounded-lg self-start sm:self-center">
              ...
              <span className="font-medium text-gray-800 text-sm sm:text-base">Ver Camiones</span>
            </div>
          </Link>
        </div>
      </div>
