...
import { ModalConfirmacionCompra, ModalConfirmacionSalidaCompra } from '../../components/compra/ModalesConfirmacionCompra';
...
function RegistrarCompraContent() {
  ...
  const handleRegistrarCompra = async () => {
    const exito = await registrarCompra(proveedor, productos, total);
    if (exito) {
      clearCompra();
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      <ModalConfirmacionCompra
        ...
        proveedor={proveedor}
        total={total}
        onConfirmar={handleRegistrarCompra}
